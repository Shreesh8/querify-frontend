...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    meta: [
      ...
      { name: "description", content: "Upload CSV or Excel, chat with your data, and ship dashboards in minutes." },
      { name: "author", content: "Querify" },
      { property: "og:title", content: "Querify — AI Business Intelligence" },
      { property: "og:description", content: "AI-powered analytics platform." },
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head><HeadContent /><link rel="icon" type="image/svg+xml" href="/favicon.svg" /></head>
      <body>
        {children}
        <Scripts />
      </body>
